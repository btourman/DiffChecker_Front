! function(a, b, c, d) {
  ...
  g.prototype.init = function(b) {
    this.tree = [], this.children = [], b.data && ("string" == typeof b.data && (b.data = a.parseJSON(b.data)), this.tree = a.extend(!0, [], b.data), delete b.data), this.options = a.extend({}, f.settings, b), this.destroy(), this.subscribeEvents(), this.setInitialStates({
      children: this.tree
    }, 0), this.render()
    ...
    c !== b.state.expanded && (c && b.children ? (b.state.expanded = !0, d.silent || this.$element.trigger("nodeExpanded", a.extend(!0, {}, b))) : c || (b.state.expanded = !1, d.silent || this.$element.trigger("nodeCollapsed", a.extend(!0, {}, b)), b.children && !d.ignoreChildren && a.each(b.children, a.proxy(function(a, b) {
    ...
    if (b) {
      ...
      a.each(b, function(b, e) {
        ...
        var h = [];
        if (e.children ? (h.push("expand-icon"), h.push(e.state.expanded ? d.options.collapseIcon : d.options.expandIcon)) : h.push(d.options.emptyIcon), f.append(a(d.template.icon).addClass(h.join(" "))), d.options.showIcon) {
          var h = ["node-icon"];
        ...
        return f.append(d.options.enableLinks ? a(d.template.link).attr("href", e.href).append(e.name) : e.name), d.options.showTags && e.tags && a.each(e.tags, function(b, c) {
          f.append(a(d.template.badge).append(c))
        }), d.$wrapper.append(f), e.children && e.state.expanded && !e.state.disabled ? d.buildTree(e.children, c) : void 0
      })
    }
    ...
    return this.children[b.parentId]
  }, g.prototype.getSiblings = function(a) {
    var b = this.identifyNode(a),
      c = this.getParent(b),
      d = c ? c.children : this.tree;
    ...
    this.forEachIdentifier(b, c, a.proxy(function(a, b) {
      this.setExpandedState(a, !0, b), a.children && b && b.levels && this.expandLevels(a.children, b.levels - 1, b)
    }, this)), this.render()
  }, g.prototype.expandLevels = function(b, c, d) {
    d = a.extend({}, f.options, d), a.each(b, a.proxy(function(a, b) {
      this.setExpandedState(b, c > 0 ? !0 : !1, d), b.children && this.expandLevels(b.children, c - 1, d)
    }, this))
    ...
    return "number" == typeof a ? this.children[a] : a
    ...
    c = c || "g", d = d || "name";
    var e = this;
    return a.grep(this.children, function(a) {
